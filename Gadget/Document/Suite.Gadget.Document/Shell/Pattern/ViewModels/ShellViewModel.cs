...
using Gadget.Document.Shell.Presentation;
using Gadget.Document.Shell.Pattern.Models;
//---------------------------//

namespace Gadget.Document.Shell.Pattern.ViewModels
{
  ...
  public class TShellViewModel : TShellViewModel<TShellModel>
  {
    ...
    public TShellViewModel (IShellPresentation presentation)
      : base (new TShellModel (), TProcess.DOCUMENT)
    {
