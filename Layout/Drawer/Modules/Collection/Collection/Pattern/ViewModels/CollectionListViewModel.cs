...
namespace Layout.Collection.Pattern.ViewModels
{
  ...
  public class TCollectionListViewModel : TViewModelAware<TCollectionListModel>, IHandleMessageInternal, ICollectionListViewModel
  {
    ...
    {
      // to parent
      var action = Server.Models.Component.TEntityAction.Create (Server.Models.Infrastructure.TCategory.Drawer, Server.Models.Infrastructure.TOperation.Collection, Server.Models.Infrastructure.TExtension.Full);
    ...
    void RequestDataContentDispatcher ()
    {
      ...
      //action.SelectType (Server.Models.Infrastructure.TContextType.Context.Drawer);
