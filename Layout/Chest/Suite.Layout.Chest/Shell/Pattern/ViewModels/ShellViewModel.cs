...
using Layout.Chest.Shell.Presentation;
using Layout.Chest.Shell.Pattern.Models;
//---------------------------//

namespace Layout.Chest.Shell.Pattern.ViewModels
{
  ...
  public class TShellViewModel : TShellViewModel<TShellModel>
  {
    ...
    public TShellViewModel (IShellPresentation presentation)
      : base (new TShellModel (), TProcess.CHEST)
    {
