...
namespace Layout.Factory.Pattern.ViewModels
{
  ...
  public class TFactoryPropertyViewModel : TViewModelAware<TFactoryPropertyModel>, IHandleMessageInternal, IFactoryPropertyViewModel
  {
    ...
    public void OnApplyCommadClicked ()
    {
      ...
      var action = TEntityAction.Create (Server.Models.Infrastructure.TCategory.Chest, Server.Models.Infrastructure.TOperation.Insert);

      if (IsViewModeEdit) {
        action = TEntityAction.Create (Server.Models.Infrastructure.TCategory.Chest, Server.Models.Infrastructure.TOperation.Change, Server.Models.Infrastructure.TExtension.Full);
      }
