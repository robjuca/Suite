...
using Layout.Shelf.Shell.Presentation;
using Layout.Shelf.Shell.Pattern.Models;
//---------------------------//

namespace Layout.Shelf.Shell.Pattern.ViewModels
{
  ...
  public class TShellViewModel : TShellViewModel<TShellModel>
  {
    ...
    public TShellViewModel (IShellPresentation presentation)
      : base (new TShellModel (), TProcess.SHELF)
    {
